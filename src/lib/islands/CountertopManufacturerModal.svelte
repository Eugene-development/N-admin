<script>
    ...
    let modalTitle = $derived(manufacturer ? 'Редактировать производителя' : 'Добавить производителя');
            ...
            <div class="modal-body">
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        {:else}
                            <select id="category" bind:value={formData.category_id} class:error={errors.category_id}>
                    ...
                    <div class="form-group full-width">
                        ...
                        {#if formData.logo}
                            <div class="logo-preview">
                                <img src={formData.logo} alt="Preview" onerror={(e) => e.target.style.display = 'none'}>
                            </div>
                        {/if}
                    </div>
